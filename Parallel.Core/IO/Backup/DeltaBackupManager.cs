...
namespace Parallel.Core.IO.Backup
{
    ...
    public class DeltaBackupManager : BaseFileManager
    {
        ...
        /// <inheritdoc />
        public override Task BackupFilesAsync(SystemFile[] systemFiles, IProgress progress)
        {
            throw new NotImplementedException();
        }

        /// <inheritdoc />
        public override Task RestoreFilesAsync(SystemFile[] systemFiles, IProgress progress)
        {
            throw new NotImplementedException();
        }
    }
