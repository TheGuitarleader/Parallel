...
namespace Parallel.Core.Database
{
    ...
    public class SqliteContext : IDatabase
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            await connection.ExecuteAsync("CREATE TABLE IF NOT EXISTS `manifests` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `name` TEXT NOT NULL, `path` TEXT NOT NULL, `lastwrite` LONG INTEGER NOT NULL);");
